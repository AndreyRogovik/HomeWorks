...
class AddressBook(UserDict):
    ...
    def search(self, query):
        found_records = []
        for record in self.data.values():
            if query in record.name.get_value() or any(query in phone.get_value() for phone in record.phones):
                found_records.append(record)
        return found_records
    

def main():
    # Ініціалізація адресної книги та завантаження даних, якщо файл існує
    ...
    try:
        ...
        print("Address book file not found. Starting with an empty address book.")
    ...
    while True:
        ...
        #нові команди для ДЗ 12  ________________________________________________________
            ...
            try:
                ...
                print("Address book file not found.")
